defmodule World.Users do
  ...
  alias World.Users.{User, UserToken, UserNotifier}
  ...
  @doc "Gets a user by phone and password"
  ...
  @doc "Returns an `%Ecto.Changeset{}` for changing the user email"
  def change_user_email(user, attrs \\ %{}) do
    User.email_changeset(user, attrs, validate_email: false)
  end

  @doc "Emulates that the email will change without actually changing it in the database"
  ...
  def deliver_user_confirmation_instructions(%User{} = user, confirmation_url_fun)
    ...
    if user.confirmed_at do
      ...
      {_encoded_token, user_token} = UserToken.build_phone_token(user, "confirm")
      Repo.insert!(user_token)
      # TODO:
